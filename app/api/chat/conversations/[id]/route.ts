...
import { getConversationById, getParticipantIds, isParticipant } from '@/lib/db/chat-queries';
...
export async function GET(
  ...
  if (conv.type === 'dm') {
    ...
    participants = other ? [{ id: other.id, full_name: other.full_name, nickname: other.nickname }] : [];
