...
export const DEFAULT_SITE_CONFIG: Record<string, string> = {
  ...
  text_regolamento_overall_8:
    "Per i tornei a 8 giocatori (4 coppie): il punteggio overall dipende solo dalla posizione finale. 1° +2, 2° +1, 3° nessuna variazione, 4° (ultimo) -1.",
  text_regolamento_overall_12:
    "Torneo Saliscendi (12 giocatori, 6 coppie): il punteggio overall dipende solo dalla posizione finale. 1° +3, 2° +2, 3° +1, 4° nessuna variazione, 5° -1, 6° (ultimo) -2.",
  ...
  text_regolamento_overall_delta:
    "Torneo a 16 giocatori: il punteggio overall dipende solo dalla posizione finale. 1° +3, 2° +2, 3° +1, 4°–6° nessuna variazione, 7° -1, 8° -2.",
